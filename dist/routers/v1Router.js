...
const superadminRoute_1 = __importDefault(require("./v1/superadminRoute"));
const festivoRoute_1 = __importDefault(require("./v1/festivoRoute"));
...
v1Router.use("/superadmin", superadminRoute_1.default);
v1Router.use("/festivo", festivoRoute_1.default);
